...
function openBrush() {
    ...
    brush.win = window.open("/brush.html?" + brushId, "_blank", "top=" + (window.screenY + 100) +
    ...
    brush.win.onbeforeunload = function () {
...
document.getElementById("calibrate").addEventListener("click", function (_) {
    modal.classList.add("is-active");
    var calibrator = window.open("/calibrator.html", "_blank", "top=" + (window.screenY + 100) +
        ",left=" + (window.screenX + 100) +
        ",width=" + (200 * devicePixelRatio) +
        ",height=" + (200 * devicePixelRatio));
    calibrator.onbeforeunload = function () {
        modal.classList.remove("is-active");
    };
}, false);
document.getElementById("cancel-calibration").addEventListener("click", function (_) { return modal.classList.remove("is-active"); }, false);
var colors = {
    black: 0xff000000,
    white: 0xffffffff,
    red: 0xff0000ff
